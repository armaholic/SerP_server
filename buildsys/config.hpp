...
class SerpMod_BuildSys_FortTypeDialog
{
	...
	class FTList: SerpMod_Buildsys_MyRscListBox
	{
		...
		onLBSelChanged = "_this call compile preprocessFileLineNumbers ('serp\buildsys\_on_ftlist_sel.sqf')";
	 };
};
...
class SerpMod_BuildSys_BuildAllowanceDialog
{
	...
	class GPList: SerpMod_Buildsys_MyRscListBox
	{
		...
		onLBSelChanged = "_this call compile preprocessFileLineNumbers ('serp\buildsys\_on_gplist_sel.sqf')";
	 };
